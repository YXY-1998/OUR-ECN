...
def handle_pkt(pkt):
    ...
    if ip.src == "10.0.1.1":  
        ...
        if elapsed_time1 >= 1:
            ...
            count1 = 0
            with open('data/q/throughput-tcn-q1.txt', 'a') as f:
                f.write(str(th1)+'\n')
                start_time1 = time.time()
        #计算RTT
        ...
        t1=t1*1000#单位ms
        with open('data/q/rtt-tcn-q1.txt', 'a') as f:
            f.write(str(t1)+'\n')
        ...
        if pkt.haslayer(IPOption_INT):
            ...
            #print(qdepth)
            with open('data/q/qdepth1-tcn-q1.txt', 'a') as f:
                f.write(str(qdepth1)+'\n')
            with open('data/q/qdepth2-tcn-q1.txt', 'a') as f:
                f.write(str(qdepth2)+'\n')
    ...
    if ip.src == "10.0.1.2":  
        ...
        if elapsed_time2 >= 1:
            ...
            count2 = 0
            with open('data/q/throughput-tcn-q2.txt', 'a') as f:
                f.write(str(th2)+'\n')
                start_time2 = time.time()
        #计算RTT
        time1=pkt.time#数据包发送时间
        ...
        t2=t2*1000#单位ms
        with open('data/q/rtt-tcn-q2.txt', 'a') as f:
            f.write(str(t2)+'\n')
        #队列长度      
        if pkt.haslayer(IPOption_INT):
            #pkt.show2()
            ...
            qdepth1 = options.int_headers[1].qdepth
            #print(qdepth)
            with open('data/q/qdepth1-tcn-q2.txt', 'a') as f:
                f.write(str(qdepth1)+'\n')
            with open('data/q/qdepth2-tcn-q2.txt', 'a') as f:
                f.write(str(qdepth2)+'\n')
    ...
    if ip.src == "10.0.1.3":  
        ...
        if elapsed_time3 >= 1:
            ...
            count3 = 0
            with open('data/q/throughput-tcn-q3.txt', 'a') as f:
                f.write(str(th3)+'\n')
                start_time3 = time.time()
        #计算RTT
        time1=pkt.time#数据包发送时间
        ...
        t3=t3*1000#单位ms
        with open('data/q/rtt-tcn-q3.txt', 'a') as f:
            f.write(str(t3)+'\n')    
        #队列长度      
        if pkt.haslayer(IPOption_INT):
            #pkt.show2()
            ...
            qdepth1 = options.int_headers[1].qdepth
            #print(qdepth)
            with open('data/q/qdepth1-tcn-q3.txt', 'a') as f:
                f.write(str(qdepth1)+'\n')
            with open('data/q/qdepth2-tcn-q3.txt', 'a') as f:
                f.write(str(qdepth2)+'\n')        
