...
from GA.doublesoeaobjnon.MyProblem1 import MyProblem1     # Import a custom problem interface
from GA.doublesoeaobjnon.MyProblem2 import MyProblem2     # Import a custom problem interface
import numpy as np
