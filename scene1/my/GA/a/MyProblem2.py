...
class MyProblem2(ea.Problem):                
    def __init__(self, N,mu1,mu2,mu3,n,C,W2,mu):
        ...
        self.W2=W2
        self.mu=mu
        name = 'MyProblem2'                  # Initialize name (function name)
        M = 1                             # Target dimension
        maxormins = [1]                    # List of target minimum-maximization tags
    ...
    def aimFunc(self, pop):                 
        ...
        # The feasibility rule is used to deal with constraints, and the degree matrix of individual violation of constraints is generated
