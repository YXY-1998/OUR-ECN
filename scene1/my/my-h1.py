...
class controller():
    ...
    def read_and_write(self):
        ...
        self.controller.register_reset("lambda_register")#initialize
        ...
        while True:
            ...
            if (lambda1!=0 or lambda2!=0 or lambda3!=0):
                ...
                if(mu1==0 and mu2==0 and mu3==0):#Default value if there is no solution
                    omega1=300
                    omega2=300
                    omega3=300
                    k1=21
                    k2=21
                    k3=21                
                if(mu1 !=0 or mu2!=0 or mu3!=0):#When there is a solution
                ...
                with open('h1.txt', 'a') as f:
                    ...
                    f.write(str1)
            self.controller.register_reset("lambda_register")#lambda_register=0            
            t1=time.time()
            time.sleep(2)                              
